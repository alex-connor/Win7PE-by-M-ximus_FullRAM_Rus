...
Восстановление данных: R-Studio, R.Saver, O&O DiskRecovery, Recuva, Restoration, TestDisk, WinHex, MBR-Fix, VictoriaHDD (загружаемый образ дискеты).
...
Интернет-приложения: uTorrent, Putty, HyperTerminal, Tor, MyLanViewer, IP-Tools, утилиты от Nirsoft для просмотра истории, кэша, паролей и куков в браузерах Mozilla Firefox, Opera, Safari, Chrome и Internet Explorer.

Офис: DJVU-Reader, SumatraPDF, xCHM, Shtirlitz4, Notepad++, AkelPad, SoftMakerOffice (внешний wim-пакет).
...
Hабота на системах с 512Мб RAM и ниже в большинстве случаев возможна только с файлом подкачки.

=======================================================================================================================

Примечания:

В папке /boot.wim расположены системные файлы и внутренние программы. Её содержимое нужно запаковать с файл boot.wim с аттрибутом Загрузочный (все это можно сделать с помощью Imagex или GImagex) и поместить в папку Sources в корне LiveCD-диска.
