...
".\boot.wim\windows\system32\imagex.exe" /capture /boot /compress maximum ".\boot.wim" ".\wim-files\sources\boot.wim" "Win7Pe by M@xiMus"
...
for /d %%f in (".\programs\*.wim") do ".\boot.wim\windows\system32\imagex.exe" /capture /boot /compress maximum "%%~dpnxf" ".\wim-files\Programs\%%~nxf" "%%~nf"
