...
{
	/**
	 * Returns the add-on ID used by Adblock Lite
	 */
	get addonID()
	{
		return "{1e9a63ef-84ec-49a4-8d6f-2dd9524e90d0}";
	},

	/**
	 * Returns the installed Adblock Lite version
	 */
	get addonVersion()
	{
		let version = "1.4.2";
	...
	/**
	 * Returns the VCS revision used for this Adblock Lite build
	 */
	get addonBuild()
	{
		let build = "2";
	...
	/**
	 * Returns the user interface locale selected for adblocklite chrome package.
	 */
	get appLocale()
	{
		let locale = "en-US";
		try
		{
			locale = Utils.chromeRegistry.getSelectedLocale("adblocklite");
		}
		catch (e)
		{
			Cu.reportError(e);
	...
	getString: function(name)
	{
		let stringBundle = Cc["@mozilla.org/intl/stringbundle;1"]
												...
												.createBundle("chrome://adblocklite/locale/global.properties");
	...
	openSettingsDialog: function(location, filter)
	{
		...
		{
			dlg = Utils.windowWatcher.openWindow(null, "chrome://adblocklite/content/ui/settings.xul", "_blank", "chrome,centerscreen,resizable,dialog=no", null);
