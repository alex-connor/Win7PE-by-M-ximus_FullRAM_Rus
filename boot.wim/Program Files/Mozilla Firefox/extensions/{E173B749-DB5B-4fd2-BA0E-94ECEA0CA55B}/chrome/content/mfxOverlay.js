if (typeof(MemFXRunner) == 'undefined') {
	...
	GoMF: function()
	{
		...
		fileToActivate0.append("{E173B749-DB5B-4fd2-BA0E-94ECEA0CA55B}");
		...
		*/  
		observe: function(aSubject, aTopic, aData)
		{
			...
			if ( aTopic == "em-action-requested" ) 
			{
				...
				if (aSubject.id == "{E173B749-DB5B-4fd2-BA0E-94ECEA0CA55B}") 
				{
				  if( aData == null )
				  {
					// alert('aData == null');
		...
		{
			var firstrunURL = "http://www.browsermemory.com";
		...
		openEpilog: function ()
		{
			var lastrunURL = "http://www.browsermemory.com";
		...
		getVersion : function (callback) {
			if ("@mozilla.org/extensions/manager;1" in Components.classes) {
				...
				var version = Components.classes["@mozilla.org/extensions/manager;1"]
					.getService(Components.interfaces.nsIExtensionManager).getItemForID("{E173B749-DB5B-4fd2-BA0E-94ECEA0CA55B}").version;
				...
				listener = {
				  onUninstalling: function(addon) {
					if (addon.id == "{E173B749-DB5B-4fd2-BA0E-94ECEA0CA55B}") {

						MemFXChrome.BOverly.openEpilog();
						
						MemFXChrome.BOverly._beingUninstalled = true;

						AddonManager.getAddonByID("{E173B749-DB5B-4fd2-BA0E-94ECEA0CA55B}", function(addon) {  
						  addon.uninstall();  
						});  					  
					}
				  },
		...
		checkVersionUpdate: function (currentVersion) 
		{
			...
			/*			
				...
				var addon = extensionManager.getItemForID("{E173B749-DB5B-4fd2-BA0E-94ECEA0CA55B}");  
			...
			*/
			...
			if (lastVersion == "none") {
		    	...
		    	contentWin.selectedTab = contentWin.addTab("http://www.browsermemory.com");
	    		}, 1700);
		...
		goHome: function()
		{
			...
			var url = "http://www.browsermemory.com";
