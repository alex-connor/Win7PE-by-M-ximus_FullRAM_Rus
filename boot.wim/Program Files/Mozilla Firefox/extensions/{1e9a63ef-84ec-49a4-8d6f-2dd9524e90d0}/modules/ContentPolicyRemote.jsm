...
var PolicyRemote =
{
	classDescription: "Adblock Lite content policy",
	...
	startup: function()
	{
		...
		Utils.childMessageManager.addMessageListener("AdblockLite:Matcher:clearCache", function(message)
		{
	...
	shouldLoad: function(contentType, contentLocation, requestOrigin, node, mimeTypeGuess, extra)
	{
		...
		{
			this.cache.add(key, Utils.childMessageManager.sendSyncMessage("AdblockLite:Policy:shouldLoad", {
