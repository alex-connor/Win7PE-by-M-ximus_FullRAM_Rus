...
const prefRoot = "extensions.adblocklite.";

/**
 * Will be set to true if Adblock Lite is scheduled to be uninstalled on
 * browser restart.
 * @type Boolean
 */
...
/**
 * Preferences branch containing Adblock Lite preferences.
 * @type nsIPrefBranch
 */
...
/**
 * This object allows easy access to Adblock Lite preferences, all defined
