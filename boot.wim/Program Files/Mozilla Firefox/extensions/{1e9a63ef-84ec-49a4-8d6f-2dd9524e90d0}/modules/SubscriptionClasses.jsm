...
DownloadableSubscription.prototype =
{
	 ...
	 * if the user doesn't use Adblock Lite for some time.
	 * @type Number
	 */
	lastCheck: 0,
	...
	/**
	 * Minimal Adblock Lite version required for this subscription
	 * @type String
	 */
	requiredVersion: null,

	/**
	 * Should be true if requiredVersion is higher than current Adblock Lite version
	 * @type Boolean
	 */
