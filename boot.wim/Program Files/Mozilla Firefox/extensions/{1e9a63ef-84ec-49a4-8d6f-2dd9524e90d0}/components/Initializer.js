...
{
	classDescription: "Adblock Lite initializer",
			...
			case "profile-after-change":
				...
				if (appInfo.ID != "{a23983c0-fd0e-11dc-95ff-0800200c9a66}")
				{
					try
					{
						...
						Cu.import("chrome://adblocklite-modules/content/Bootstrap.jsm");
					}
					catch (e)
					{
						...
						let bootstrapURL = chromeRegistry.convertChromeURL(ioService.newURI("chrome://adblocklite-modules/content/Bootstrap.jsm", null, null));
